...
/////////////////////////////////////////////////      built.io functions        ///////////////////////////////////////////////////
    (function (root) {
        ...
        Built.removeTenant= function () {
            if(Headers['tenant_uid']){
                delete Headers['tenant_uid'];
            }
            return Built;
        }
        ...
        Built.removeHeader=function(headerName){
            if(typeof headerName=="string" && headerName!=="" && headerName !="authtoken" && Headers[headerName]){
        ...
        Built.File= function (args) {
            ...
            this.destroy= function (callback) {
                if (object_uid) {
                    ...
                    var me = this,
                        option = {},
                        myPromise=buildPromise(callback);
                        callback=myPromise.__options;
                    ...
                    myPromise._XHR=rets._XHR;
                    myPromise.abort=rets.abort;
                    return myPromise;
            ...
            this.save= function (callback){
                ...
                if(shadow['upload']){
                    ...
                    var myPromise=buildPromise(callback);
                    callback=myPromise.__options;
    ...
    (function (root) {
        ...
        Built.User.login = function (email, pass, option) {
            ...
            if (typeof email != 'string' || typeof pass != 'string') {
                return option.onError({error_message:"Email and Password required"}, null);
            }
            var myPromise=buildPromise(option);
            option=myPromise.__options;
            var cb = function (data, res) {
                try { data = JSON.parse(data) } catch (e) { }
                if (typeof data == 'object' && data.application_user) {
                    ...
                    Built.Events.trigger('user:login', data, 'built');
            ...
            var rets= REST.USER.login(Headers, data, cb, {});
            myPromise._XHR=rets._XHR;
            myPromise.abort=rets.abort;
            return myPromise;
        }
        ...
        Built.User.update=function(options, callback){
            ...
            callback=myPromise.__options;
            if(appUserInfo &&
                typeof appUserInfo=="object" &&
                appUserInfo.uid &&
                Headers.authtoken &&
                Headers.application_api_key &&
                Headers.application_uid){
                var cb = function (data, res) {
                    try { data = JSON.parse(data) } catch (e) { }
                    if (typeof data == 'object' && data.notice) {
                        appUserInfo =  data.application_user;
                        if(Headers.authtoken){
                            appUserInfo.authtoken;
                        }
                        if (typeof callback.onSuccess == 'function') {
                            callback.onSuccess(data, res);
                        }
                ...
                var rets= REST.USER.update(Headers, options, cb, appUserInfo);
                myPromise._XHR=rets._XHR;
                myPromise.abort=rets.abort;
                return myPromise;
            ...
            if(typeof accessToken=='string'){
                ...
                var cb={
                    ...
                    onSuccess: function (data, res) {
                        ...
                        Built.Events.trigger('user:login', data, 'google');
                        if(typeof callback.onSuccess=='function'){
                            callback.onSuccess(data,res);
                        }
                    }
                }
                var myPromise=buildPromise(cb);
                cb=myPromise.__options;
            ...
            if(typeof accessToken=='string' && typeof host=='string'){
                ...
                var cb={
                    ...
                    onSuccess: function (data, res) {
                        ...
                        Built.Events.trigger('user:login', data, 'tibbr');
                        if(typeof callback.onSuccess=='function'){
                            callback.onSuccess(data,res);
                        }
                    }
            ...
            if(typeof accessToken=='string'){
                ...
                var cb={
                    ...
                    onSuccess: function (data, res) {
                        ...
                        Built.Events.trigger('user:login', data, 'facebook');
                        if(typeof callback.onSuccess=='function'){
                            callback.onSuccess(data,res);
                        }
                    }
            ...
            if(typeof twrObj=='object' && twrObj.consumer_key && twrObj.consumer_secret && twrObj.token && twrObj.token_secret){
                ...
                var cb={
                    ...
                    onSuccess: function (data, res) {
                        ...
                        Built.Events.trigger('user:login', data,'twitter');
                        if(typeof callback.onSuccess=='function'){
                            callback.onSuccess(data,res);
                        }
                    }
        ...
        Built.User.saveSession = function () {
            ...
            if (typeof appUserInfo === 'object' &&
                typeof localStorage !== 'undefined' &&
                Headers['application_api_key']) {
                if(Headers.authtoken){
                    appUserInfo.authtoken=Headers.authtoken;
                }
                localStorage.setItem(Headers['application_api_key'], JSON.stringify(appUserInfo));
                Built.Events.trigger('user:save-session', appUserInfo);
            }
            return this;
        }
        /**
        ...
        Built.User.setCurrentUser = function (key) {
            if (typeof key == 'object' && key !=null && key.authtoken) {
                appUserInfo = key;
                if(key.authtoken){
                    Headers.authtoken = appUserInfo.authtoken;
                }else if(Headers.authtoken){
                    appUserInfo.authtoken=Headers.authtoken;
                }
                Built.Events.trigger('user:set-current-user', appUserInfo);
            }
            return this;
        }
        /**
        ...
        Built.User.getSession = function () {
            if (typeof Headers['application_api_key'] === 'undefined') {
                throw new Error("initialize built.io sdk using Built.init(apiKey, appUid)");
            }
            try{
                if(localStorage.getItem(Headers['application_api_key'])){
        ...
        Built.User.clearSession = function () {
            appUserInfo = null;
            try{delete Headers['authtoken']}catch(e){}
            try{localStorage.removeItem(Headers['application_api_key'])}catch(e){}
        ...
        Built.User.logout = function (option) {
            ...
            var cb = function (data, res) {
                ...
                if (data && typeof data == 'object' && typeof data.notice !== "undefined") {
                    ...
                    Built.Events.trigger('user:logout');
                    if (typeof option.onSuccess == 'function') {
                        option.onSuccess(data, res);
                    }
                } else {
            ...
            var rets= REST.USER.logout(Headers, {}, cb, {});
            myPromise._XHR=rets._XHR;
            myPromise.abort=rets.abort;
            return myPromise;
        }
        ...
        */
        Built.User.register = function (options, callback) {
            ...
            var cb = function (data, res) {
                    try { data = JSON.parse(data) } catch (e) { }
                    if (data && typeof data == 'object' && typeof data.notice !== "undefined") {
                        Built.Events.trigger('user:register',data);
                        if (typeof callback.onSuccess == 'function') {
                            callback.onSuccess(data, res);
                        }
                    } else {
            ...
            var rets= REST.USER.register(Headers, data, cb, {});
            myPromise._XHR=rets._XHR;
            myPromise.abort=rets.abort;
            return myPromise;
        }
        ...
        Built.User.activate= function (userId,activationToken, callback) {
            if(typeof userId =='string' && typeof activationToken=='string'){
                ...
                var cb = function (data, res) {
                    try { data = JSON.parse(data) } catch (e) { }
                    if (data && typeof data == 'object' && typeof data.notice !== "undefined") {
                        Built.Events.trigger('user:activate',data);
                        if (typeof callback.onSuccess == 'function') {
                            callback.onSuccess(data, res);
                        }
                    } else {
                ...
                var rets= REST.USER.activate(Headers, {}, cb, options);
                myPromise._XHR=rets._XHR;
                myPromise.abort=rets.abort;
                return myPromise;
            }else{
        ...
        Built.User.deactivate = function (userId,callback) {
            ...
            var cb = function (data, res) {
                ...
                if (data && typeof data == 'object' && typeof data.notice !== "undefined") {
                    appUserInfo = null;
                    Built.Events.trigger('user:deactivate', data);
            ...
            var rets= REST.USER.deactivate(Headers, {}, cb, {userId:userId});
            myPromise._XHR=rets._XHR;
            myPromise.abort=rets.abort;
            return myPromise;
        }
        ...
        Built.User.getCurrentUser = function () {
             return Built.Util.clone((appUserInfo||{}));
        }
        /**
        ...
        Built.User.refreshUserInfo = function (option) {
            ...
            var rets= REST.USER.fetchUserInfo(Headers, {}, cb, {});
            myPromise._XHR=rets._XHR;
            myPromise.abort=rets.abort;
            return myPromise;
        }
        ...
        Built.User.forgotPassword = function (email, option) {
            ...
            var rets= REST.USER.forgotPassword(Headers, data, cb, {});
            myPromise._XHR=rets._XHR;
            myPromise.abort=rets.abort;
            return myPromise;
        }
        ...
        */
        Built.User.fetchUserByAuthtoken = function(authtoken){
            var promise = new Built.Promise,
                head = {
                application_api_key : Headers['application_api_key'],
                application_uid : Headers['application_uid'],
                authtoken : authtoken
            }
            var cb = function (data, res) {
                try { data = JSON.parse(data) } catch (e) { }
            ...
            var rets = REST.USER.fetchUserInfo(head, {}, cb, {});
        ...
        var fetchUidByMail = function(data,callback){
            ...
            var rets= REST.USER.fetchUidByEmail(Headers,data,cb);
            myPromise._XHR=rets._XHR;
            myPromise.abort=rets.abort;
            return myPromise;
        }
        ...
        Built.User.generateAuthtoken = function(query, insert, userObject){
            ...
            if(! query instanceof Built.Query){
                throw error("Built.Query object required for filtering user");
            }
            var myPromise = buildPromise();
            var cb = function (data, res) {
                try { data = JSON.parse(data) } catch (e) { }
                if (typeof data === 'object' && data.application_user) {
                    myPromise.resolve(data.application_user, res);
                } else {
                    myPromise.reject(data, res);
                }
            }
            var data = { 
                insert : insert,
        ...
        Built.User.__setUser__ = function (resObject) {
            ...
            if(typeof resObject == "object" && resObject.notice &&
                ...
                appUserInfo = resObject.application_user;
                Headers['authtoken'] = resObject.application_user.authtoken;
                return true;
            }
            return false;
        }
    ...
    (function (root) {
        ...
        Built.Object = function (classUid, attrbs, emptyShadow) {
            ...
            this.fetch= function (callback) {
                ...
                var rets= REST.OBJECT.fetch(_head, __q, cb, option);
                myPromise._XHR=rets._XHR;
                myPromise.abort=rets.abort;
                return myPromise;
            }
            ...
            */
            ...
            this.save= function (callback) {
                ...
                if (typeof object_uid == 'string' && object_uid.length > 0) {
                    __q.object = shadow ;
                    var rets=REST.OBJECT.update(_head, __q, cb, option);
                    myPromise._XHR=rets._XHR;
                    myPromise.abort=rets.abort;
                } else {
                    var dataObj = Built.Util.mix({ object: shadow },obj_options);
                    dataObj = Built.Util.mix(dataObj, __q);
                    var rets= REST.OBJECT.create(_head, dataObj, cb, option);
                    myPromise._XHR=rets._XHR;
                    myPromise.abort=rets.abort;
                }
                return myPromise;
            ...
            this.destroy= function (callback) {
                ...
                if (object_uid) {
                    option.object_uid = object_uid;
                    var rets= REST.OBJECT.destroy(_head, {}, cb, option);
                    myPromise._XHR=rets._XHR;
                    myPromise.abort=rets.abort;
                    return myPromise;
            ...
            var _getSchema=function(callback,me){
                ...
                return REST['CLASS'].fetch(_head, {}, cb, option);
            }
...
////////////////////////////////////////////////        Built.Query              ///////////////////////////////////////////////////
    (function (root) {
        ...
        Built.Query = function (className) {
            ...
            var _setter = function (key, condition, value, operator) {
                if(operator){
            ...
            var _checkOrMake= function(obj,key){
            ...
            var _toQueryString = function (args) {
            ...
            */
            ...
            this.exec= function (options) {
                ...
                var cacheStr=JSON.stringify(_head)+option.class_uid+JSON.stringify(opt);
                try { opt = JSON.parse(opt) } catch (e) { }
                //---------------------------------------------------
                var myPromise=buildPromise(options);
                options=myPromise.__options;
                myPromise.__preserve(true);
                ...
                var execute=function(){
                    return REST.OBJECT.fetch(_head,opt,cb,option);
                }
            ...
            this.count= function (callback) {
                ...
                if (typeof class_uid == 'string' && class_uid.length > 0) {
                    ...
                    d.count = true;
                    var rets=REST.OBJECT.fetch(_head, d, cb, option);
                    myPromise._XHR=rets._XHR;
                    myPromise.abort=rets.abort;
                    return myPromise;
                } else {
                ...
                if(typeof options.onSuccess=='function'){
                    ...
                    if(typeof data ==="object" && data.objects){
                        for(var i=0;i<data.objects.length;i++){
                            roleObjs.push(new Built.Role(data.objects[i]));
                        }
                    }
                    for(var j in data){
                        if(j!=="objects" && j!=="object"){
                            roleObjs[j]=data[j];
                        }
                    }
                    options.onSuccess(roleObjs,res);
                }
            });
            return promise;
            */
